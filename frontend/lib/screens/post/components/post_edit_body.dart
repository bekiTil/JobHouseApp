...
class _PostBodyState extends State<PostBody> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PostBloc, PostState>(builder: (context, state) {
      if (state is PostEditingOperationStarted) {
        categorySelected = state.post.category;
        _descriptionController.text = state.post.description;
        _numberController.text = state.post.number.toString();
      }
      ...
      return Form(
        ...
        child: Column(
          children: [
            Text(
              state is PostEditingOperationStarted
                  ? "Edit Your Post"
                  : "Post a new Job",
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                  labelText: 'Number of available places'),
